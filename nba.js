window.onload = function () {
    ...
    $("#find-player").on("click", function(event) {
        $.ajax({
            ...
            //using set item t get two arguemnents (the key and the value) 
            var myStorage = window.localStorage
            console.log(foundPlayerData);
            //it needs to be set as an a string, but its an object now
            myStorage.setItem("currentPlayer", JSON.stringify(foundPlayerData));
            
            myStorage.getItem("currentPlayer");
            
            console.log(myStorage.getItem("currentPlayer"));
